...
import { selectWishList, SET_WISHLIST } from "../../redux/slice/wishListSlice";
...
export default function WhishList(props: WhishListProps) {
  ...
  const currentList = wishListData.slice(indexOfFirstPost, indexOfLastPost);
  console.log(
              ...
              <div className="search-wrap-content" id="wrap-content-top">
                ...
                <div className="wrap-right">
                  ...
                  <div className="item-icon-list">
                    <img className="add-to-card" src={cardSearchIcon} alt="" />
                    <img
                      className="add-to-wishlish"
                      src={heartSearchIcon}
                      alt=""
